...
public class Duplicate_existing_Lot extends AppCompatActivity
    ...
    private static final String TAG = Duplicate_existing_Lot.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_duplicate_lot);
        ...
        adapter = new CustomListLotAdapter(Duplicate_existing_Lot.this, categoryList, Duplicate_existing_Lot.this);
        ...
        if(isNetworkAvailable() == true) {
            ...
            AlertDialog alertDialog = new AlertDialog.Builder(Duplicate_existing_Lot.this).create();
        ...
        search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(isNetworkAvailable() == true) {
                     ...
                     Log.e("A_L....", Auction_name+" ..Lot_name.. "+ Lot_name+"...lot_status "+lot_status);
                    // Store values at the time of the login attempt.
                    lotno =lot_no.getText().toString();
                    if (lotno.equals("")) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener()
        {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                LotNumber = tempValues.getLotno();
                tempValues.getAuctionno();
                tempValues.getLotstatus();

                Log.e("ttLotstatus()", tempValues.getLotstatus());
                Log.e("lot_status(", lot_status);
                Log.e(".1. ",LotNumber +" .2. "+ tempValues.getLotstatus() +" .3. "+tempValues.getAuctionno()+" .4. "+Auction_name);
                Log.e(" .5.", Lot_name +" .6. "+lot_status+" .7."+LocalVar);

                Intent i = new Intent(Duplicate_existing_Lot.this, Lot_Details_New.class);
                i.putExtra("lotname",LotNumber);
                i.putExtra("name",tempValues.getAuctionno());
                i.putExtra("lot_status_o",tempValues.getLotstatus());
                i.putExtra("AA",Auction_name);
                i.putExtra("LL",Lot_name);
                i.putExtra("lot_status",lot_status);
                i.putExtra("LocalVar",LocalVar);
                i.putExtra("upc","1234");
                startActivity(i);
                //create_duplicate_lot(LotNumber);
            }
        });
        ...
        add_new_lot.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if( isNetworkAvailable() == true) {
                    Intent i = new Intent(Duplicate_existing_Lot.this, Add_New_Auction.class);
                    startActivity(i);
                }
                else
                {
    ...
    public void dataForAdmin(){
        ...
        Log.e(TAG, " AppConfig.URL_Lot_search : " + AppConfig.URL_lot_search);

        StringRequest strReq = new StringRequest(Method.GET,
                AppConfig.URL_lot_search, new Response.Listener<String>() {

            @Override
            public void onResponse(String response) {
                Log.d(TAG, "user details Response: " + response.toString());
                hideDialog();
                Log.e(TAG, "sdfdsgfgfg : " + AppConfig.URL_lot_search);

                try {
                    JSONObject jObj = new JSONObject(response);
                    Log.e(TAG, "try if: " + AppConfig.URL_lot_search);
                    ...
                    if(code.equals("lots found"))
                    {
                        ...
                        for (int i = 0; i < auction_arry.length(); i++) {
                            try {
                                ...
                                Log.e("D lot_no.....", lot_no);
                                Log.e("D auction_no.....", auction_no);
                                Log.e("D lot_status.....", lot_status);
                                Log.e("D item_title.....", item_title);
                                Log.e("D description..", description);
                    ...
                    e.printStackTrace();
                    Log.e(TAG, "catch : " + AppConfig.URL_lot_search);
                }
            }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.user_setting) {
            Intent i = new Intent(Duplicate_existing_Lot.this, User_Settings.class);
            startActivity(i);
        }
                ...
                editor.clear();
                editor.commit();
                Intent intent = new Intent(Duplicate_existing_Lot.this, Login_Activity.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                startActivity(intent);
                finish();

        }  else if (id == R.id.history) {
            Intent i = new Intent(Duplicate_existing_Lot.this, Auction_History.class);
            startActivity(i);
        }
        else if (id == R.id.home) {
            Intent i = new Intent(Duplicate_existing_Lot.this, Auction_Screen_Main.class);
            startActivity(i);
            finish();
        }
        else if (id == R.id.user) {
            Intent i = new Intent(Duplicate_existing_Lot.this, New_lot.class);
            startActivity(i);
            finish();
        }
        DrawerLayout drawer = (DrawerLayout) findViewById(R.id.drawer_layout);
    ...
    public void loadMoreListView() {
        if(isNetworkAvailable() == true)
        {
            ...
            if(user_role_label.equals("Super Admin"))
            {
                Toast.makeText(Duplicate_existing_Lot.this, user_role_label, Toast.LENGTH_SHORT).show();
                LoadMoreForSAdmin();
            }
            else {
                Toast.makeText(Duplicate_existing_Lot.this, "no", Toast.LENGTH_SHORT).show();
                LoadMoreForAdmin();
            }
        }
        else {
