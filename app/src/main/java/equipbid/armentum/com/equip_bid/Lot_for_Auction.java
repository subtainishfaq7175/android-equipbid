...
public class Lot_for_Auction extends AppCompatActivity
    ...
    private TextView auction_found_;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lot_for_auction);
        ...
        {
            adapter = new CustomLotListAdapter(Lot_for_Auction.this, categoryList);
        ...
        add_new_lot.setOnClickListener(new View.OnClickListener() {
            ...
            Intent i = new Intent(Lot_for_Auction.this, Create_New_Auction_Lot.class);
            i.putExtra("name","");
            startActivity(i);
            }
        });
        ...
        listview.setOnItemClickListener(new AdapterView.OnItemClickListener()
        {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                Intent i = new Intent(Lot_for_Auction.this, Lot_Details_New.class);
    ...
    private void getSearchOfflineAuctionLot(String p_id, String p_token, String auction_name) {
        ...
        if(LocalList.size()>0){
            ...
            adapterLocal = new CustomLocalAdapter(Lot_for_Auction.this, LocalList);
            ...
            listviewLocal.setOnItemClickListener(new AdapterView.OnItemClickListener()
            {
                ...
                public void onItemClick(AdapterView<?> parent, View view,
                    ...
                    i.putExtra("Flag", tempValues.getFlag());
                    i.putExtra("LocalVar",LocalVar);
                    startActivity(i);
                }
            });
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.user_setting) {
            Intent i = new Intent(Lot_for_Auction.this, User_Settings.class);
            startActivity(i);
        }
            ...
            editor.clear();
            editor.commit();
            Intent intent = new Intent(Lot_for_Auction.this, Login_Activity.class);
            intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
            startActivity(intent);
            finish();
        }
        else if (id == R.id.history) {
            Intent i = new Intent(Lot_for_Auction.this, Auction_History.class);
            startActivity(i);
        }else if (id == R.id.home) {
            Intent i = new Intent(Lot_for_Auction.this, Auction_Screen_Main.class);
            startActivity(i);
            finish();
        }
        else if (id == R.id.user) {
            Intent i = new Intent(Lot_for_Auction.this, New_lot.class);
            startActivity(i);
            finish();
        }
