...
public class User_Settings extends AppCompatActivity
    ...
    private static final String TAG = User_Settings.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        {
                AlertDialog alertDialog = new AlertDialog.Builder(User_Settings.this).create();
    ...
    private void getProfile(final String p_id,final String p_token) {
        ...
        Log.e(TAG, " AppConfig.URL_REGISTER : " + AppConfig.URL_USER+p_id+"?context=edit");
        ...
        StringRequest strReq = new StringRequest(Method.GET,
            ...
            public void onResponse(String response) {
                ...
                hideDialog();
                Log.e(TAG, "sdfdsgfgfg : " + AppConfig.URL_USER+p_id+"?context=edit");

                try {
                    JSONObject jObj = new JSONObject(response);
                    Log.e(TAG, "try : " + AppConfig.URL_USER+p_id+"?context=edit");
                    Log.e(TAG, "try if: " + AppConfig.URL_USER+p_id+"?context=edit");
    ...
    public void onBackPressed() {
        ...
        if (drawer.isDrawerOpen(GravityCompat.START)) {
            ...
            Intent i = new Intent(User_Settings.this, Auction_Screen_Main.class);
            startActivity(i);
            finish();
        }
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.edit) {
            Intent i = new Intent(User_Settings.this, Edit_User_Setting.class);
            startActivity(i);
            finish();
        }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.user_setting) {
            Intent i = new Intent(User_Settings.this, User_Settings.class);
            startActivity(i);
            finish();
        }
                ...
                editor.clear();
                editor.commit();
                Intent intent = new Intent(User_Settings.this, Login_Activity.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                startActivity(intent);
                finish();
        }
        else if (id == R.id.history) {
            Intent i = new Intent(User_Settings.this, Auction_History.class);
            startActivity(i);
            finish();
        }
            ...
            Intent i = new Intent(User_Settings.this, New_lot.class);
            startActivity(i);
            finish();
        }
        DrawerLayout drawer = (DrawerLayout) findViewById(R.id.drawer_layout);
